 ...
 */
public class ProgrammeerTaal implements Comparable<ProgrammeerTaal>, Serializable {
    ...
    public ProgrammeerTaal(String naam, String oprichter, String extensionName,
        ...
        this(-1,naam,oprichter,extensionName,laatsteVersie,aantalGebruikers,stijl,opgerichtIn);
    }

    public ProgrammeerTaal(int id, String naam, String oprichter, String extensionName,
                           double laatsteVersie, int aantalGebruikers, Stijl stijl, LocalDate opgerichtIn) {
        setNaam(naam);
