...
public class Data {
    ...
    public static List<ProgrammeerTaal> getLijst() {
        ...
        talen.add(new ProgrammeerTaal("", "James Gosling", ".java", 9,
                9000000, Stijl.OBJECTORIENTED, LocalDate.of(1995, 5, 23)));
        talen.add(new ProgrammeerTaal("R", "", ".r", 3.4,
                1500000, Stijl.FUNCTIONEEL, LocalDate.of(1993, 8, 1)));
        talen.add(new ProgrammeerTaal("C", "Dennis Ritchie", ".c", 99,
                2520000, Stijl.IMPERATIEF, LocalDate.of(1800, 1, 1)));
        talen.add(new ProgrammeerTaal("Python", "Guido van Rossum", "", 3.6,
