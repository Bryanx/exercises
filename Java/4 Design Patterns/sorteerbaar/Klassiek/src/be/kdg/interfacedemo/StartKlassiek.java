...
/**
 * De main methode van dit programma is exact gelijk aan dit van StartDynamisch.
 * In dit deel van de opgave moet je in de klassen Getallen en Woorden gebruik
 * maken van een klassieke tabel. Het sortenen zelf gebeurt met de bubble sort
 * methode.
 */
public class StartKlassiek {
