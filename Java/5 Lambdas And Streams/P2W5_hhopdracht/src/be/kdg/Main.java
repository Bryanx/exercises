...
import be.kdg.stalling.Garage;
import be.kdg.stalling.GeenPlaatsGevondenException;
import be.kdg.stalling.Plaats;
import be.kdg.voertuigen.*;

import java.time.LocalDate;
import java.util.ArrayList;
import java.util.List;
import java.time.LocalDate; import java.util.ArrayList; import java.util.Iterator; import java.util.List; import java.util.Random;
